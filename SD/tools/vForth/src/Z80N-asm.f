...
HEX \ -->  DP @ LP ! HEX E080 DP !
  
\  : INVERT -1 XOR ;
: @+ >R R@ CELL+ R> @ ;
: !+ >R R@ ! R> CELL+ ;
: @- 0 CELL+ - >R R@ @ R> ;
1 VARIABLE TABL1 1 ,       TABL1 !   
: ROTLEFT  TABL1 + @
  UM* \ U*
  OR ;
\
...
\   + @ AND ;
0 VARIABLE    TALLY-BI       TALLY-BI  !
0 VARIABLE    TALLY-BY       TALLY-BY  !
0 VARIABLE    TALLY-BA       TALLY-BA  !
0 VARIABLE    ISS            ISS       !
0 VARIABLE    ISL            ISL       !
0 VARIABLE    PREVIOUS       PREVIOUS  !
...
IS-A IS-COMMA : COMMAER
    <BUILDS , 0 , , , , , DOES>
    REMEMBER COMMA ;
0 VARIABLE PRO-TALLY  2 CELLS ALLOT      PRO-TALLY ! 
: T! PRO-TALLY !+ !+ !+ DROP ;
...
\ 02 44 2 EDFAMILY,   NEG  IM0 
\ 08 45 2 EDFAMILY,   RETN RETI 
\ 08 56 2 EDFAMILY,   IM1 IM2 
\ 08 47 6 EDFAMILY,   LDIA LDRA LDAI LDAR RRD RLD
