...
01 C, 03FD ,      \ ldx     bc|  HEX 03FD  NN,      \    03FD
...
DD C, 21 C,       \ ldx     ix|  AFX-CH-DESC NN,
    AFX-CH-DESC ,
55 C,             \ ld      d'|     l|
16 C, 06 C,       \ ldn     e'|  DECIMAL 6 N,
ED C, 30 C,       \ mul
DD C, 19 C,       \ addix   de|                     \ ix : AFX-CH-DESC, +12, +36
11 C, AFX-MIXER , \ ldx     de| AFX-MIXER NN,   
19 C,             \ addhl   de|                     \ hl': AFX-MIXER, +2, +4
06 C, 03 C,       \ ldn     b'|  hex  03   N,       \ b' : 3
