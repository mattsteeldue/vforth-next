...
NEEDS .FREE-SIZE .FREE-SIZE 

CR 

\ display CPU speed 3.5, 7.0, 14.0 or 28.0 
7 REG@  3 AND  35    \ speed expressed in 100kHz
SWAP LSHIFT             \ multiply by two n times.
0 <# # CHAR . HOLD #S #> TYPE SPACE ." MHz Z80n CPU Speed." 

CR

\ display memory available
SP@ PAD  - U. ." bytes free in Dictionary." 

CR

 -1 HP @ - U. ." bytes free in Heap."
