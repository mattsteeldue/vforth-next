...
Variable_Ptr:
                ...
                inc     de
                push    de                  // balance TOS before overwrite it
...
//
                ...
                User_Def HP         , "HP"        , 70 // heap-pointer address
...
// CFA: +3+n routine address. Colon definitions here have pointer to code
// PFA: +5+n "is_code", definitions have no PFA. 
//
...
Code_Endif:                                     // endif                
                ...
                dw      HERE, CELL_PLUS, COMMA  // ( CFA point PFA )
                dw      EXIT                    // ;
