...
//  DE - Top of Stack element. The second from top is pointed by SP
//  HL - Working 
// 
...
//    - Words that collides with Assembler are normally suffixed with "_OP"
...
//              SAVETAP "output/F15j.tap", CODE, "forth15j", $6400, 9000

                SAVEBIN "output/forth15j.bin", ORIGIN, 9400
